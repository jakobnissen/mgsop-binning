# Metagenomics standard operating procedure - assembly
...
It is part of the mgsop pipeline, along with module `binning`
...
If this is not the case, the "template" string in mgsop.py must be changed to be the desired
Snakemake command.
